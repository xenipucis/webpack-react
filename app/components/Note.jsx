...
export default class Note extends React.Component {
  ...
  renderEdit = () => {
    ...
    // We set selection to input end using a callback at ref.
    // It gets triggered after the component is mounted.
    // We could also use a string reference (i.e., ref = "input") and
    // then refer to the element in question later in the code. This would
    // allow us to use the underlying DOM API.
  ...
  finishEdit = (e) => {
    // 'Note' wil trigger an optional 'onEdit' callback once it has a new value.
